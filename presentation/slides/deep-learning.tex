...
\begin{frame}[fragile]{Convolutional Neural Networks: Mechanics}
  ...
  \begin{tikzpicture}
    ...
    \foreach \x/\i in {4/10, 4.4/11, 4.8/12, 5.2/13, 5.6/14} {
      \only<\i-> {
        \yzplane{\x}{
...
\begin{frame}[fragile]{Convolutional Neural Networks: Pooling}
  ...
  \begin{tikzpicture}
    ...
    \only<1> {\fourgrid{6}{32}{66}{2}}
    \only<2> {\fourgrid{6}{32}{\red 66}{2}}
    \only<3> {\fourgrid{\red 66}{32}{6}{2}}
    \only<4> {\fourgrid{6}{32}{2}{\red 66}}
    \only<5> {\fourgrid{2}{\red 66}{32}{6}}
